  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative min-h-[38px] rounded-lg border-[#e2e7ee] border-input text-sm transition-shadow focus-within:border-ring focus-within:outline-none focus-within:ring-[3px] focus-within:ring-ring/20 has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50",
            {
        ...
        <div className="relative">
          <div
            className={cn(
              "absolute top-1 z-10 w-full overflow-hidden rounded-lg border-[#e2e7ee] border",
